        ...
        for (var k=0; k<fieldslength; k++){
            ...
            if(fieldName === "OBJECTID" || fieldName === "LEASE_NAME" || fieldName === "WELL_NAME"){
                ...
                if(component.status == Component.Ready){
                    var propertiesObject = JSON.parse("{\"role\":\"" + fieldName + "\",\"title\":\"" + fieldName + "\",\"visible\":true,\"width\":150}");
        ...
        GridLayout {
            ...
            ContentBlock {
                ...
                Column {
                    ...
                    Text{
                        font.pointSize: 10
                        text:"Click on a point, then click on the buttons to query for relationships. \nAfter fields are populated, change the values, and press enter to save"
                    }
                }
            }
            GridLayout{
                ...
                ContentBlock {
                    ...
                    Column {
                        ...
                        Button{
                            id: firstRel
                            text: "Query For First Relationship"
                ...
                ContentBlock{
                    ...
                    Column {
                        ...
                        Button{
                            id: secondRel
                            text: "Query For Second Relationship"
                            enabled: queryenabled
                            onClicked: {
